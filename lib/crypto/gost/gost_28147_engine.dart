...
import 'package:mobile_ung/crypto/gost/parameters_with_sbox.dart';
...
class GOST28147Engine {
  ...
  void init(bool forEncryption, CipherParameters params) {
    if (params is ParametersWithSBox) {
      ...
      if (param.Parameters != null) {
        _workingKey = _generateWorkingKey(forEncryption, (param.Parameters as KeyParameter).Key);
      }
  ...
  List<int> _generateWorkingKey(bool forEncryption, List<int> userKey) {
    ...
    if (userKey.length != 32) {
      throw Exception('Key length invalid. Key needs to be 32 byte - 256 bit!!!');
    }
  ...
  static List<int> getSBox(String sBoxName) {
    ...
    if (sBox == null) {
      throw Exception('Unknown S-Box - possible types: "Default", "E_Test", "E_A", "E_B", "E_C", "E_D", "D_Test", "D_A".');
    }
